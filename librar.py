...
# Now 'book_details' contains the desired dictionary
        ...
        lblTitle = Label(DataFrameLeft, bg="Maroon", fg="White", text="ID ", font=("times new roman ", 12, "bold"),
                         padx=2, pady=6)
...
class UpdateWindow:
    def __init__(self, root):
        ...
        DataFrameLeft = LabelFrame(frame, text="Book Information", bg="Maroon", fg="white", bd=12, relief=RIDGE,
                                       font=("times new roman ", 12, "bold"))
        ...
        btnAddData = Button(DataFrameLeft,command=self.Addbooks, text="Addbooks", font=("times new roman ", 12, "bold"), width=20, bg="Maroon",
                            fg="white")
        btnAddData.grid(row=4, column=2)

        btnAddData = Button(DataFrameLeft,command=self.iExit, text="Exit", font=("times new roman ", 12, "bold"), width=20, bg="Maroon",
                            fg="white")
...
def main():
    ...
    lbltitle = Label(main_window , text="A.H.A LIBRARY MANAGEMENT", bg="Maroon", fg="white", bd=20, relief=RIDGE,
                         font=("times new roman ", 50, "bold"), padx=2, pady=6)
    lbltitle.pack(side=TOP, fill=X)
    ...
    launch_button = Button(main_window, text="Issue Books", command=lambda: LibraryManagementSystem(main_window),font=("times new roman ", 15, "bold") ,bg="maroon",fg="white",width=20,height=10)
    launch_button.place(x=300, y=200)

    # Create a button to open the update window for adding books
    add_book_button = Button(main_window, text="Add Books", command=lambda: UpdateWindow(main_window),font=("times new roman ", 15, "bold") ,bg="maroon",fg="white",width=20,height=10)

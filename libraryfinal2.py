...
class LibraryManagementSystem:
    def __init__(self, root):
        self.root = root
        self.root.title("A.H.A Library Management System")
...
# Now 'book_details' contains the desired dictionary
        ...
        lbltitle = Label(self.root, text="AHA LIBRARY MANAGEMENT", bg="midnight blue", fg="dark Orange", bd=20, relief=RIDGE,
                         font=("times new roman ", 50, "bold"), padx=2, pady=6)
        lbltitle.pack(side=TOP, fill=X)

        frame = Frame(self.root, bd=12, relief=RIDGE, padx=20, bg="midnight blue")
        frame.place(x=0, y=110, width=1550, height=800)

        # Dataframeleft

        DataFrameLeft = LabelFrame(frame, text="Member Information", bg="midnight blue", fg="dark Orange", bd=12, relief=RIDGE,
                                   font=("times new roman ", 12, "bold"))
        DataFrameLeft.place(x=0, y=5, width=900, height=350)

        lblMember = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Member Type",
        ...
        lblPRN = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="PRN No ", font=("times new roman ", 12, "bold"),
                       padx=2, pady=6)
        ...
        lblTitle = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="ID ", font=("times new roman ", 12, "bold"),
                         padx=2, pady=6)
        lblTitle.grid(row=2, column=0, sticky=W)
        txtTitle = Entry(DataFrameLeft, font=("times new roman ", 12, "bold"), textvariable=self.id_var, width=28)
        txtTitle.grid(row=2, column=1)

        lblFirstName = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="First Name ",
                             font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblLastName = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Last Name  ",
                            font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblAddress1 = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Address Pri ",
                            font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblAddress2 = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Address Sec ",
                            font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblPostCode = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Post Code ",
                            font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblMobile = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Mobile", font=("times new roman ", 12, "bold"),
                          padx=2, pady=6)
        lblMobile.grid(row=8, column=0, sticky=W)
        txtMobile = Entry(DataFrameLeft, font=("times new roman ", 12, "bold"), textvariable=self.mobile_var, width=28)
        txtMobile.grid(row=8, column=1)

        lblBookId = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Book ID ",
                          font=("times new roman ", 12, "bold"), padx=2, pady=6)
        lblBookId.grid(row=0, column=2, sticky=W)
        txtBookId = Entry(DataFrameLeft, font=("times new roman ", 12, "bold"), textvariable=self.bookid_var, width=28)
        txtBookId.grid(row=0, column=3)

        lblBookTitle = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Book Title ",
                             font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblAuthor = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Author Name  ",
                          font=("times new roman ", 12, "bold"), padx=2, pady=6)
        lblAuthor.grid(row=2, column=2, sticky=W)
        txtAuthor = Entry(DataFrameLeft, font=("times new roman ", 12, "bold"), textvariable=self.author_var, width=28)
        txtAuthor.grid(row=2, column=3)

        lblDateBorrowed = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Date Borrowed ",
                                font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblDateDue = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Date Due ",
                           font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblDaysonbook = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Days on book",
                              font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblLateReturnFine = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Late Return Fine ",
                                  font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblDateOverDue = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Date Over Due ",
                               font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        lblActualPrice = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Actual Price ",
                               font=("times new roman ", 12, "bold"), padx=2, pady=6)
        ...
        DataFrameRight = LabelFrame(frame, text="Book Details", bg="midnight blue", fg="dark Orange", bd=12, relief=RIDGE,
                                    font=("times new roman ", 12, "bold"))
        ...
        framebutton = Frame(self.root, bd=12, relief=RIDGE, padx=20, bg="Midnight blue")
        ...
        btnAddData = Button(framebutton, command=self.add_data, text="Add Data", font=("times new roman ", 12, "bold"),
                            width=23, bg="midnight blue", fg="dark Orange")
        btnAddData.grid(row=0, column=0)

        btnAddData = Button(framebutton,command=self.showData, text="Show Data", font=("times new roman ", 12, "bold"), width=23, bg="midnight blue", fg="dark Orange")
        btnAddData.grid(row=0, column=1)

        btnAddData = Button(framebutton,command=self.update ,text="Update ", font=("times new roman ", 12, "bold"), width=23,bg="midnight blue", fg="dark Orange")
        btnAddData.grid(row=0, column=2)

        btnAddData = Button(framebutton,command=self.delete, text="Delete", font=("times new roman ", 12, "bold"), width=23, bg="midnight blue", fg="dark Orange")
        btnAddData.grid(row=0, column=3)

        btnAddData = Button(framebutton,command=self.reset ,text="Reset", font=("times new roman ", 12, "bold"), width=23, bg="midnight blue", fg="dark Orange")
        btnAddData.grid(row=0, column=4)

        btnAddData = Button(framebutton,command=self.iExit, text="Exit", font=("times new roman ", 12, "bold"), width=23,bg="midnight blue", fg="dark Orange")
        btnAddData.grid(row=0, column=5)

        # Information Frame
        FrameDetails = Frame(self.root, bd=12, relief=RIDGE, padx=20, bg="Midnight blue")
        FrameDetails.place(x=0, y=580, width=1550, height=220)

        Table_frame = Frame(FrameDetails, bd=6, relief=RIDGE, bg="Midnight blue")
...
class UpdateWindow:
    def __init__(self, root):
        ...
        DataFrameLeft = LabelFrame(frame, text="Book Information", bg="midnight blue", fg="dark Orange", bd=12, relief=RIDGE,
                                       font=("times new roman ", 12, "bold"))
        DataFrameLeft.place(x=0, y=120, width=900, height=200)


        lblPRN = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Book Name ",
                           font=("times new roman ", 12, "bold"),
                           padx=2, pady=6)
        lblPRN.grid(row=1, column=0, sticky=W)
        ...
        lblTitle = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Book ID",
                             font=("times new roman ", 12, "bold"),
                             padx=2, pady=6)
        lblTitle.grid(row=2, column=0, sticky=W)
        ...
        lblFirstName = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Book Title ",
                                 font=("times new roman ", 12, "bold"), padx=2, pady=6)
        lblFirstName.grid(row=3, column=0, sticky=W)
        ...
        lblLastName = Label(DataFrameLeft, bg="midnight blue", fg="dark Orange", text="Author ",
                                font=("times new roman ", 12, "bold"), padx=2, pady=6)
        lblLastName.grid(row=4, column=0, sticky=W)
        ...
        btnAddData = Button(DataFrameLeft,command=self.Addbooks, text="Addbooks", font=("times new roman ", 12, "bold"), width=20,bg="midnight blue", fg="dark Orange")
        btnAddData.grid(row=4, column=2)

        btnAddData = Button(DataFrameLeft,command=self.iExit, text="Exit", font=("times new roman ", 12, "bold"), width=20, bg="midnight blue", fg="dark Orange")
        btnAddData.grid(row=4, column=3)
...
def main():
    ...
    main_window = Tk()
    main_window.title("A.H.A Library Management System Launcher")
    main_window.geometry("1550x750+0+0")

    lbltitle = Label(main_window , text="A.H.A LIBRARY MANAGEMENT", bg="midnight blue", fg="dark Orange", bd=20, relief=RIDGE,
                         font=("times new roman ", 50, "bold"), padx=2, pady=6)
    lbltitle.pack(side=TOP, fill=X)
    ...
    launch_button = Button(main_window, text="Issue Books", command=lambda: LibraryManagementSystem(main_window),font=("times new roman ", 15, "bold") ,bg="midnight blue", fg="dark Orange",width=20,height=10)
    launch_button.place(x=400, y=300)

    # Create a button to open the update window for adding books
    add_book_button = Button(main_window, text="Add Books", command=lambda: UpdateWindow(main_window),font=("times new roman ", 15, "bold") ,bg="midnight blue", fg="dark Orange",width=20,height=10)
    add_book_button.place(x=900, y=300)
